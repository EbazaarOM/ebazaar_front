...
// /* Initial desktop container width divided by initial html font size 1560/10 */
// const desktopRatio = 192;
// /* Initial mobile width divided by initial html font size 768/10 */
// const mobileRatio = 76.8;

// const getFontSizeVal = (containerWidth, ratio) => `${+containerWidth.slice(0, -2) / ratio}px`;
...
// //   getDesktopScreenOptions(themeScreens.desktop, '1440px'),
// //   getDesktopScreenOptions(themeScreens.hd, '1560px')
// // ];
